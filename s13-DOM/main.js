...
divEles.forEach((ele) => (ele.onclick = (e) => console.log(e.target)));
...
// } else {
//   let str = Object.values(dictionary).filter((ele) => ele.includes(input));
//   str[0] ? findKey(dictionary, str) : console.log("not found");
// }
...
// 1. In tat ca xe
// 2.Nhap vi tri xe can tim
// 3.Nhap loai xe can tim
// 4.Them nha san xuat cho xe
// 5.Tim xe theo ten nha san xuat
// 0.Thoat`);
...
// displayByIndex(+input);
function displayByCategory(input) {
  cars.forEach((x, i) => {
    if (x.category == input) {
      console.log(`\n-------------------------
      \nName: ${x.names}
...
// displayByCategory(input.toLowerCase());
...
function addProperty(property, index) {
  cars.forEach((car, i) => {
    if (index == i + 1) {
      car[property] = prompt(`Enter a ${property} of --${car.names}--`);
      console.log(car);
    }
  });
}
// addProperty("property", +input);

function findPoperty(propertyInput) {
  cars.forEach((car) => {
    if (car[property] == propertyInput) {
      console.log(`\n-------------------------
      \nName: ${x.names}
      \nBrand: ${x.brand}
      \nPrice: ${x.price}
...
//       break;
//     case 2:
//       displayByIndex(+prompt("nhap so xe can tim "));
//       break;
//     case 3:
//       displayByCategory(prompt("nhap loai xe can tim ").toLowerCase());
//       break;

//     case 4:
//       addProperty("provider", +prompt("nhap so xe muon them "));
//       break;
//     case 6:
//       findPoperty(prompt("nhap ten nha san xuat can tim"));
//       break;
//   }
...
let courses = [
  ...
  { name: "Basics of JavaScrip", complete: false },
  { name: "Git", complete: false },
];

// let task = +prompt(
//   "Enter your task (1.New, 2.Delete, 3.Update, 4.Complete 0.Exit)"
// );
// function displayAll() {
...
//   courses.push({ name: newCourse, complete: false });
// }

// function updateCourse() {
//   let pos = +prompt("Enter position");
//   let newName = prompt("Enter new title");
//   courses[pos - 1].name = newName;
// }

// function isComplete() {
//   courses[+prompt("ENter position") - 1].complete = true;
// }
...
// function displayFirstJob(i) {
//   return jobs["hits"][i];
// }

// console.log(displayFirstJob(0).jobTitle);
// displayFirstJob(0)["benefits"].forEach((benefit) => {
//   console.log("- " + benefit["benefitValue"]);
// });

// jobs["hits"].forEach((hit) => {
//   console.log(hit.jobTitle);
//   hit["benefits"].forEach((benefit) => {
//     console.log("- " + benefit["benefitValue"]);
//   });
// });
